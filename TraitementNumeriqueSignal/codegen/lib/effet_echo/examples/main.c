...
#include "effet_echo_terminate.h"
 ...
 * Return Type  : void
 */
void main_effet_echo(void)
{
  double signal_in_tmp;
  /* Initialize function 'effet_echo' input arguments. */
  signal_in_tmp = argInit_real_T();
  /* Call the entry-point 'effet_echo'. */
  signal_in_tmp = effet_echo(signal_in_tmp, signal_in_tmp, signal_in_tmp);
}
