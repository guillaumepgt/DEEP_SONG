...
void mexFunction(int32_T nlhs, mxArray *plhs[], int32_T nrhs,
                 const mxArray *prhs[])
{
  mexAtExit(&effet_echo_atexit);
  effet_echo_initialize();
  unsafe_effet_echo_mexFunction(nlhs, plhs, nrhs, prhs);
                                   ...
                                   const mxArray *prhs[3])
{
  ...
  b_prhs[1] = prhs[1];
  b_prhs[2] = prhs[2];
  effet_echo_api(b_prhs, &outputs);
  /* Copy over outputs to the caller. */
  emlrtReturnArrays(1, &plhs[0], &outputs);
}

/*
 * File trailer for _coder_effet_echo_mex.c
 *
 * [EOF]
 */
